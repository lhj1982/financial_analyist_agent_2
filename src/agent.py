...
Keeps the LLM responsible for *synthesis* and *personalization*.
Regime classification itself is deterministic (see regime.py).
"""
...
SYSTEM_PROMPT = """你是一位严格、理性的市场分析师 Agent。
...
def run_agent(
    ...
    Args:
        ...
        portfolio_summary: Optional pre-computed portfolio analysis to inject.
    ...
    for iteration in range(max_iterations):
        ...
        # Normalize assistant message into dict format for the next round
